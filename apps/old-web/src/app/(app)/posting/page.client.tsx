  ...
  return (
    <form className="space-y-6" onSubmit={handleSubmit}>
      <div className="flex items-center justify-between">
        <Button onClick={goToAccountsStep} outline type="button">
      ...
      <div className="flex flex-wrap gap-2 rounded-lg bg-zinc-50 dark:bg-zinc-900">
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
        ...
        <div className="space-y-6">
          <Card className="sticky top-4">
            <div className="p-4">
              <h3 className="mb-4 font-medium text-base">Live Preview</h3>
              ...
              >
                {uniquePlatforms.length > 1 && (
                  <TabList className="relative mb-4 flex gap-2 overflow-x-auto pb-1">
                    {uniquePlatforms.map((platform, index) => {
                      ...
                      return (
                        <Tab
                          className={clsx(
                            "group relative flex items-center gap-2 rounded-full border px-3 py-1.5 font-medium text-sm/6 transition-all focus:outline-none",
                            index === activePreviewTab
                              ? "border-blue-500 bg-blue-50 text-blue-700 shadow-sm dark:border-blue-700 dark:bg-blue-950 dark:text-white"
                ...
                <div className="mb-4 border-zinc-200 border-b dark:border-zinc-700" />
