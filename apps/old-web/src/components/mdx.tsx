...
export function Tip({ children }: { readonly children: React.ReactNode }) {
  return (
    <div className="my-6 flex gap-2.5 rounded-2xl border border-emerald-500/20 bg-emerald-50/5 p-4 text-emerald-900 leading-6 dark:border-emerald-500/30 dark:bg-emerald-500/5 dark:text-emerald-200 dark:[--tw-prose-links-hover:theme(colors.emerald.300)] dark:[--tw-prose-links:theme(colors.white)]">
...
export function Note({ children }: { readonly children: React.ReactNode }) {
  return (
    <div className="my-6 flex gap-2.5 rounded-2xl border border-blue-500/20 bg-blue-50/5 p-4 text-blue-900 leading-6 dark:border-blue-500/30 dark:bg-blue-500/5 dark:text-blue-200 dark:[--tw-prose-links-hover:theme(colors.blue.300)] dark:[--tw-prose-links:theme(colors.white)]">
...
export function Warn({ children }: { readonly children: React.ReactNode }) {
  return (
    <div className="my-6 flex gap-2.5 rounded-2xl border border-amber-500/20 bg-amber-50/50 p-4 text-amber-900 leading-6 dark:border-amber-500/30 dark:bg-amber-500/5 dark:text-amber-200 dark:[--tw-prose-links-hover:theme(colors.amber.300)] dark:[--tw-prose-links:theme(colors.white)]">
...
export function Danger({ children }: { readonly children: React.ReactNode }) {
  return (
    <div className="my-6 flex gap-2.5 rounded-2xl border border-red-500/20 bg-red-50/50 p-4 text-red-900 leading-6 dark:border-red-500/30 dark:bg-red-500/5 dark:text-red-200 dark:[--tw-prose-links-hover:theme(colors.red.300)] dark:[--tw-prose-links:theme(colors.white)]">
...
export function Property({
  ...
  let statusElement = (
    <>
      ...
      <dd className="text-emerald-500 text-xs dark:text-green-500/80">
        optional
      </dd>
    </>
  );
  ...
  if (sometimes) {
    statusElement = (
      <>
        ...
        <dd className="text-amber-400 text-xs dark:text-amber-500">
          sometimes required
        </dd>
      </>
    );
  ...
  if (required) {
    statusElement = (
      <>
        ...
        <dd className="text-red-400 text-xs dark:text-red-500">required</dd>
      </>
    );
  }
