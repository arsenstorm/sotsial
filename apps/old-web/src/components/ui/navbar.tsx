...
export const NavbarItem = forwardRef(function NavbarItem(
  ...
  const classes = clsx(
    ...
    // Avatar
    "*:data-[slot=avatar]:-m-0.5 *:data-[slot=avatar]:size-7 sm:*:data-[slot=avatar]:size-6 *:data-[slot=avatar]:[--avatar-radius:var(--radius-md)] *:data-[slot=avatar]:[--ring-opacity:10%]",
    // Hover
