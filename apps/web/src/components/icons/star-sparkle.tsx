...
export function StarSparkleIcon({ size = "24px", ...props }: IconProps) {
  return (
    <svg
      height={size}
      viewBox="0 0 24 24"
    ...
    >
      ...
      <g className="nc-icon-wrapper" fill="none">
        <path
          ...
          data-glass="origin"
          fill="url(#llrv0ntwddn-1752671328339-4791743_star-sparkle_existing_0_t5afbmhh9)"
          mask="url(#llrv0ntwddn-1752671328339-4791743_star-sparkle_mask_zol1sdobn)"
        />
        <path
          clipPath="url(#llrv0ntwddn-1752671328339-4791743_star-sparkle_clipPath_mpnb7o899)"
          d="M20.3174 8.19531C20.0357 8.8823 19.5416 9.61008 18.9248 10.332C17.6628 11.8091 15.7312 13.4472 13.4355 14.9248C11.14 16.4022 8.8494 17.4826 6.98242 18.0195C6.31873 18.2104 5.67868 18.3394 5.09375 18.3857L5.45996 16.3232C5.74837 16.2727 6.07264 16.1993 6.42969 16.0967C8.06215 15.6272 10.1747 14.6455 12.3535 13.2432C14.5326 11.8406 16.3019 10.3247 17.4053 9.0332C17.7661 8.61089 18.0377 8.22999 18.2305 7.90234L20.3174 8.19531Z"
          data-glass="clone"
          fill="url(#llrv0ntwddn-1752671328339-4791743_star-sparkle_existing_0_t5afbmhh9)"
          filter="url(#llrv0ntwddn-1752671328339-4791743_star-sparkle_filter_0fcp7fp8u)"
        />
        <path
          ...
          data-glass="blur"
          fill="url(#llrv0ntwddn-1752671328339-4791743_star-sparkle_existing_1_msjgnlsec)"
        />
        <path
          ...
          fill="url(#llrv0ntwddn-1752671328339-4791743_star-sparkle_existing_2_0fn5co6r9)"
        />
        <path
          ...
          fill="url(#llrv0ntwddn-1752671328339-4791743_star-sparkle_existing_3_yonjglwpi)"
        />
        <path
          ...
          fill="url(#llrv0ntwddn-1752671328339-4791743_star-sparkle_existing_4_dakdv8hg8)"
        />
        <path
          ...
          fill="url(#llrv0ntwddn-1752671328339-4791743_star-sparkle_existing_5_k25vmx6lf)"
        />
        <defs>
          <linearGradient
            gradientUnits="userSpaceOnUse"
            id="llrv0ntwddn-1752671328339-4791743_star-sparkle_existing_0_t5afbmhh9"
            x1="12.706"
            x2="12.706"
            y1="7.902"
            y2="18.386"
          ...
          <linearGradient
            gradientUnits="userSpaceOnUse"
            id="llrv0ntwddn-1752671328339-4791743_star-sparkle_existing_1_msjgnlsec"
            x1="12"
            x2="12"
            y1="1.801"
            y2="21.802"
          ...
          <linearGradient
            gradientUnits="userSpaceOnUse"
            id="llrv0ntwddn-1752671328339-4791743_star-sparkle_existing_2_0fn5co6r9"
            x1="12"
            x2="12"
            y1="1.801"
            y2="13.384"
          >
            <stop data-glass-light="on" stopColor="var(--nc-light,#fff)" />
            <stop
              data-glass-light="on"
              offset="1"
          ...
          <linearGradient
            gradientUnits="userSpaceOnUse"
            id="llrv0ntwddn-1752671328339-4791743_star-sparkle_existing_3_yonjglwpi"
            x1="5"
            x2="5"
            y1="1"
            y2="7"
          ...
          <linearGradient
            gradientUnits="userSpaceOnUse"
            id="llrv0ntwddn-1752671328339-4791743_star-sparkle_existing_4_dakdv8hg8"
            x1="22.25"
            x2="22.25"
            y1="15"
            y2="17.5"
          ...
          <linearGradient
            gradientUnits="userSpaceOnUse"
            id="llrv0ntwddn-1752671328339-4791743_star-sparkle_existing_5_k25vmx6lf"
            x1="11.329"
            x2="11.329"
            y1="4.893"
            y2="18.407"
          ...
          <filter
            ...
            height="400%"
            id="llrv0ntwddn-1752671328339-4791743_star-sparkle_filter_0fcp7fp8u"
          ...
          <clipPath id="llrv0ntwddn-1752671328339-4791743_star-sparkle_clipPath_mpnb7o899">
            <path
              d="M10.6642 2.61922C11.2208 1.52816 12.7794 1.52811 13.336 2.61922L15.5069 6.87508C15.7292 7.31078 16.1505 7.6107 16.6349 7.67879L21.4083 8.34969C22.654 8.52479 23.1438 10.0637 22.2286 10.9268L18.839 14.1231C18.4713 14.4699 18.3034 14.979 18.3917 15.4766L19.2003 20.0372C19.4164 21.2558 18.1473 22.1966 17.0441 21.6358L12.6798 19.418C12.2526 19.2009 11.7476 19.2009 11.3204 19.418L6.95616 21.6358C5.85285 22.1967 4.58376 21.2559 4.79991 20.0372L5.60851 15.4766C5.69678 14.9789 5.52801 14.4699 5.16027 14.1231L1.77159 10.9268C0.856418 10.0637 1.34619 8.52479 2.59191 8.34969L7.36534 7.67879C7.84961 7.61064 8.27006 7.31071 8.4923 6.87508L10.6642 2.61922Z"
              fill="url(#llrv0ntwddn-1752671328339-4791743_star-sparkle_existing_1_msjgnlsec)"
            />
          </clipPath>
          <mask id="llrv0ntwddn-1752671328339-4791743_star-sparkle_mask_zol1sdobn">
